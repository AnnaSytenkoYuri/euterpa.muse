...
export const bookingSchema = z.object({
  ...
  phone: z.string().trim().min(8, "phoneInvalid"),

  lessonFormat: z.string().min(1, "lessonFormatRequired"),

  vocalLevel: z.string().min(1, "vocalLevelRequired"),

  lessonTime: z.string().min(1, "lessonTimeRequired"),
  ...
  message: z.string().trim().max(500, "messageTooLong").optional(),
});
